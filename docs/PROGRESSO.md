...
| — | A6 | **NÃO INICIADA.** Planejador semanal (grade seg–dom × blocos, colocar áreas nos horários) + contagem regressiva de prova com "quanto do plano já cobri". Maior etapa (grid custom). Ver `docs/PLANO_TDAH.md`. |
